...
# Need to point to subproject sitemaps, not to the base URL of the documentation.
# base RTD project needs a robots.txt file pointing to a custom sitemap file generated by this script
# The sitemap generated here needs to point to subproject sitemaps - but needs to make sure they exist first
...
def main():
    ...
    template_sitemap = "{}\n{}".format(
        template_sitemap,
        template_sitemap_section(
            "https://documentation.ubuntu.com/en/latest/",
            datetime.datetime.fromisoformat(project_data["modified"]).strftime(
                "%Y-%m-%d"
            ),
        ),
    )
